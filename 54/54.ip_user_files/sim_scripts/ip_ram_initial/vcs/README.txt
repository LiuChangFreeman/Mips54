...
#
# Generated by export_simulation on Sat Jul 15 15:50:19 +0800 2017
#
################################################################################
...
switch to the './ip_ram_initial.sh' script.

./ip_ram_initial.sh -reset_run
...
./ip_ram_initial.sh -noclean_files

For more information on the script, please type './ip_ram_initial.sh -help'.
